...
public class BaseManageController {
    ...
    public Result<List<BaseCategory1>> getCategory1() {
        ...
        return Result.ok(baseCategory1List);//my:方法上的泛型在传参的时候被确定下来
    }
    ...
    //SkuInfo分页查询     http://api.gmall.com/admin/product/list/{page}/{limit}
    @GetMapping("list/{page}/{limit}")
    public Result getgetSkuInfoPage(@PathVariable Long page,
                                    @PathVariable Long limit){
        Page<SkuInfo> skuInfoPage = new Page<>(page,limit);
        IPage<SkuInfo> page1 = manageService.getPage(skuInfoPage);
        return Result.ok(page1);
    }


    //上架http://api.gmall.com/admin/product/onSale/{skuId}
